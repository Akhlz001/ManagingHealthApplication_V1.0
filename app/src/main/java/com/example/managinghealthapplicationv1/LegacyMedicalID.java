...
public class LegacyMedicalID extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        a = findViewById(R.id.legacy_rname);
        b = findViewById(R.id.legacy_rage);
        c = findViewById(R.id.legacy_rheight);
        d = findViewById(R.id.legacy_rweight);
        e = findViewById(R.id.legacy_rbloodtype);
        f = findViewById(R.id.legacy_rcondition);
        g = findViewById(R.id.legacy_rreaction);
        h = findViewById(R.id.legacy_rmedication);
